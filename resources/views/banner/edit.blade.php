                    ...
                    <div class="card">
                        <div class="card-body">
                            <form class="form-horizontal form-material mx-2" method="post"
                                action="{{ route('banner.update', ['banner' => $banner->id]) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="order" value="{{ $banner->order }}" id="order"
                                                class="form-control" placeholder="1" required>
                                        </div>
                                        <div class="btn-group">
                                            <a href="{{ asset('storage/banners/' . $banner->image) }}"
                                ...
                                <div class="form-group mt-3">
                                    <div class="col-sm-12 d-flex">
                                        <button class="btn btn-success mx-auto mx-md-0 text-white">Update Banner</button>
                                    </div>
                                </div>
                            </form>
                        </div>
